<?php
  session_start();
  if (empty($_SESSION["user_name"]) || empty($_SESSION["user_email"]) || empty($_SESSION["user_password"])) {
...
<html lang="en">
  ...
  <body class="bg-[#18191A] overflow-hidden">
    <!-- Navbar -->
    <nav
      class="block w-full max-w-screen-xl px-4 py-3 mx-auto text-white shadow-md rounded-xl bg-gradient-to-tr bg-white mt-4"
    >
      <div
        class="flex flex-wrap items-center justify-between text-white gap-y-4"
      >
        <a
          href="#"
          class="md:!text-[16px] !text-[13px] !text-black ml-2 block cursor-pointer py-1.5 font-sans text-base font-semibold leading-relaxed tracking-normal text-inherit antialiased"
        >
          Registration system
        </a>
        <a
          class="cursor-pointer align-middle select-none font-sans font-bold text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 px-6 rounded-lg bg-gray-900 text-white shadow-md shadow-gray-900/10 hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none"
          type="button"
          href="logout.php"
        >
          Logout
    ...
    <!-- Content -->
    <div class="w-full max-w-screen-xl px-4 py-3 mx-auto mt-5">
      <div class="relative flex flex-col w-full h-full text-gray-700 bg-white shadow-md rounded-xl bg-clip-border">
        <div class="relative mx-4 mt-4 overflow-hidden text-gray-700 bg-white rounded-none bg-clip-border">
          <h1 class="text-black font-[500] text-center text-[20px] text-white bg-black mb-2 p-3 rounded">
                ...
                <td class="p-4 border-b border-blue-gray-50">
                  <div class="flex items-center gap-3">
                    <img src="https://demos.creative-tim.com/test/corporate-ui-dashboard/assets/img/team-2.jpg"
                      alt="Alex Liras" class="relative inline-block h-9 w-9 !rounded-full object-cover object-center" />
                    <div class="flex flex-col">
                      <p class="block font-sans text-sm antialiased font-normal leading-normal text-blue-gray-900">
                        Alex Liras
                      </p>
